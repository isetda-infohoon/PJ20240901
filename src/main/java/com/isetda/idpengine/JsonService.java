...
public class JsonService {
    ...
    public void drawMarking(File imageFile, List<Map<String, Object>> jsonCollection) throws IOException {
        ...
        System.out.println("Annotated image saved as " + outputImageFile.getAbsolutePath());
    }
        ...
        for (File imageFile : imageFiles) {
            try {
                ...
                if (jsonFile.exists()) {
                    ...
                    System.out.println("No matching JSON file found for image: " + imageFile.getName());
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
